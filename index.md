...
Break is a question understanding dataset, aimed at probing models to reason over complex question. It features [83,978](https://github.com/allenai/Break) natural language questions, annotated with their Question Decomposition Meaning Representations (QDMRs). Break contains human composed questions, sampled from [10 leading question-answering benchmarks](#question-answering-datasets) over text, images and datbases. Each example is annotated with strong supervision in the form of its question decomposition (QDMR).
