...
Break is a dataset of natural language questions annotated with their Question Decomposition Meaning Representations (QDMRs). It features [83,978](https://github.com/allenai/Break) human composed natural questions over text, images and datbases sampled from [10 leading question-answering benchmarks](#question-answering-datasets). Each example is annotated with strong supervision in the form of its question decomposition (QDMR).
