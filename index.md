...
------------ | ------------- | ------------- | ------------- | -------------
1 | CopyNet *(Wolfson et al., TACL 2020)* | `Feb 1, 2020` | `15.40`  | `15.7`
2 | RuleBased *(Wolfson et al., TACL 2020)* | `Feb 1, 2020` | `00.00`  | `00.00` 
...
Rank | Submission | Created | EM Dev. | EM Test
------------ | ------------- | ------------- | ------------- | -------------
1 | CopyNet *(Wolfson et al., TACL 2020)* | `Feb 1, 2020` | `08.10`  | `08.30`
2 | RuleBased *(Wolfson et al., TACL 2020)* | `Feb 1, 2020` | `00.00`  | `00.00` 
